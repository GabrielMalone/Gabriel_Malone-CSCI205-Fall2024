#ifndef SHELL_HIBBARD_TEST
#define SHELL_HIBBARD_TEST
...
//------------------------------------------------------------------------------------
void runShellHibbardTests(vector<int>& list,int trial,int vect_size,char array_type, 
                         bool printArrays, 
    ...
    //--------------------------------------------------------------------------------
        cout << endl << Colors::YELLOW << "Shell Sort Hibbard Gap: " << Colors::RESET 
             << endl;
    ...
    //--------------------------------------------------------------------------------
    saveSortingData(shellCustomSortData, "shell_sort_hibbard_Gap_" + s);   // save data
    //--------------------------------------------------------------------------------
}
#endif 