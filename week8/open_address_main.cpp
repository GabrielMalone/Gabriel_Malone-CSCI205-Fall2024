...
int main(){
    ...
    //--------------------------------------------------------------------------------------------------------
    OpenHashTable<int>testmap(problem_size); // initialize an empty map. loop below will test resize functionality as well
    //--------------------------------------------------------------------------------------------------------
    // CONSTANT VARIABLE 
    //--------------------------------------------------------------------------------------------------------
    ...
    OpenHashTable<Contact> contactMap(100000);                                 // create a blank map of type Contact
