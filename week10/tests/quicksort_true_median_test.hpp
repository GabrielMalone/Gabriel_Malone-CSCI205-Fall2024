#ifndef QSORT_TRUE_MEDIAN_TEST
#define QSORT_TRUE_MEDIAN_TEST

#include <vector>
#include "../backend/colors.hpp"
#include "../backend/sort_data.hpp"
#include "../backend/print_vector.hpp"
#include "../sorting_methods/quicksort_true_median.hpp"
...
//------------------------------------------------------------------------------------
void runQuickSortTrueMedianTests(std::vector<int>& list , int trial, int vect_size, 
    ...
    cout << endl << Colors::YELLOW <<"Quick Sort True Median: " << Colors::RESET << endl;
    if (printArrays) print_vector(list);                           // see if it worked 
    quicksort_true_median(list, 0 , list.size() - 1, printArrays, sData); 
