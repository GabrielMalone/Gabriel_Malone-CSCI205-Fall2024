#ifndef QSORT_INSERTION_TEST
#define QSORT_INSERTION_TEST

#include <vector>
#include "../backend/colors.hpp"
#include "../backend/sort_data.hpp"
#include "../backend/print_vector.hpp"
#include "../sorting_methods/quicksort_insertion.hpp"
...
//------------------------------------------------------------------------------------
void runQuickSortInsertionTests(std::vector<int>& list , int trial, int vect_size, 
    ...
    cout << endl << Colors::YELLOW <<"Quick Sort Insertion: " << Colors::RESET << endl;
    if (printArrays) print_vector(list);                           // see if it worked 
    quicksort_insertion(list, 0 , list.size() - 1, printArrays, sData, median); 
